...
3. Environment variable (e.g. `AGENT__AGEPUBKEY=...`, `SERVER__HTTP_DOMAIN=...`)
4. Default configuration file (see [general/configuration file]({{< ref "01-general/04-configuration_file" >}}))
5. Compile-time defined value (`-ldflags`, or compiling with `tealc compile --env`: [general/compilation]({{< ref "01-general/02-compilation" >}}#compile-using-the-client-recommended))
