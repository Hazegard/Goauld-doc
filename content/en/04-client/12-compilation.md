...
- `-p`/`--compiler-agent-password`: sets the agent's private password (`AGENT__PRIVATE_PASSWORD`) at compile time.
- `--nopass`: compile the agent without a private password.
